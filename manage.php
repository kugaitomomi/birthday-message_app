    ...
    <section>
        <div class="max-w-lg mx-auto px-3">
            ...
            <?php if (!empty($messages)): ?>
                <?php foreach ($messages as $message): ?>
                    <div class="border-2 border-sky-500 p-5 mb-6">
                        ...
                        <div class="flex justify-center max-w-sm mx-auto space-x-4 mt-6">
                            <a href="edit.php?id=<?php echo htmlspecialchars($message['id'], ENT_QUOTES, 'UTF-8'); ?>" class="bg-cyan-600 hover:bg-cyan-800 text-white font-bold py-2 px-4 rounded mr-20">編集する</a>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p class="text-center">まだメッセージはありません。<br>最初のメッセージを投稿してみましょう！</p>
            <?php endif ?>
        </div>
        <!-- 投稿メッセージ一覧エリア end -->
    </section>
